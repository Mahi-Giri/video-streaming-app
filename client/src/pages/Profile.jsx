...
const Profile = () => {
  ...
  const [profile, setProfile] = useState({
    ...
    watchHistory: [
      "Stranger Things", "Money Heist", "Breaking Bad", "Narcos", "The Witcher", "Black Mirror",
      "The Crown", "Dark", "Ozark", "The Umbrella Academy",
    ],
    resumeVideo: [
      "The Witcher", "Black Mirror", "The Crown", "Dark", "Ozark", "The Umbrella Academy",
      "Stranger Things", "Money Heist", "Breaking Bad", "Narcos",
    ],
  });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-white font-sans overflow-y-auto pt-16 sm:pt-20">
      ...
      <div className="border-0 md:border border-white rounded-lg flex flex-col items-center justify-center space-y-4 p-8 md:p-16 shadow-lg shadow-yellow-100 w-full max-w-4xl">
  ...
  return list.length > 0 ? (
    <div key={section} className="relative mt-10 px-8 sm:px-8 md:px-12">
      <h2 className="text-white text-xl font-bold mb-4 sm:text-left ml-6 ">{section}</h2>
      <div className="relative w-full overflow-hidden">
        ...
        <div 
          ref={ref}
          className="flex gap-4 transition-transform overflow-x-auto scrollbar-hidden px-4 " // Applied the custom scrollbar-hidden class here
        >
          {list.map((item, index) => (
            <div
              key={index}
        ...
        {list.length > 3 && (
          <button
            ...
            className="absolute right-4 top-1/2 -translate-y-1/2 bg-gray-800 p-3 rounded-full z-10 sm:right-2 md:right-6 lg:right-8"
          >
      ...
      <h2 className="mt-10 px-4 sm:text-left ml-6 px-8  md:px-12 text-2xl font-bold mb-4">
        Current Plan
      </h2>
